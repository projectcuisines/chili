...
if __name__ == '__main__':
	...
	# -------------------------------------------------------------------------
	# --- trappist1e ---
	# run_chili_grid(planet='trappist1e', tau_key='tau3', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1e', tau_key='tau3', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1e', tau_key='tau4', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1e', tau_key='tau4', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1e', tau_key='tau6', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1e', tau_key='tau6', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')

	# --- trappist1b ---
	# run_chili_grid(planet='trappist1b', tau_key='tau3', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1b', tau_key='tau3', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1b', tau_key='tau4', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1b', tau_key='tau4', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1b', tau_key='tau6', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1b', tau_key='tau6', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')

	# --- trappist1alpha ---
	# run_chili_grid(planet='trappist1alpha', tau_key='tau3', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1alpha', tau_key='tau3', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1alpha', tau_key='tau4', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1alpha', tau_key='tau4', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1alpha', tau_key='tau6', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='trappist1alpha', tau_key='tau6', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')

	# --- earth ---
	# run_chili_grid(planet='earth', tau_key='tau3', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='earth', tau_key='tau3', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='earth', tau_key='tau4', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='earth', tau_key='tau4', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='earth', tau_key='tau5', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='earth', tau_key='tau5', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='earth', tau_key='tau6', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='earth', tau_key='tau6', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')

	# --- venus ---
	# run_chili_grid(planet='venus', tau_key='tau3', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='venus', tau_key='tau3', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='venus', tau_key='tau4', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='venus', tau_key='tau4', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='venus', tau_key='tau5', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='venus', tau_key='tau5', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='venus', tau_key='tau6', hot_or_cold='hot', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
	# run_chili_grid(planet='venus', tau_key='tau6', hot_or_cold='cold', use_seeded_O=True, fO2_calculation = 'MASS_BALANCE')
