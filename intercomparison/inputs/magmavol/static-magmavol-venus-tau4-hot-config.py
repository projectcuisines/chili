...
if __name__ == '__main__':
	...
	# --- venus ---
	data = run_chili_single(planet='venus', tau_key='tau3', hot_or_cold='hot', use_seeded_O=False, fO2_calculation = 'TARGET_FO2')
	data = run_chili_single(planet='venus', tau_key='tau3', hot_or_cold='cold', use_seeded_O=False, fO2_calculation = 'TARGET_FO2')
	data = run_chili_single(planet='venus', tau_key='tau4', hot_or_cold='hot', use_seeded_O=False, fO2_calculation = 'TARGET_FO2')
	data = run_chili_single(planet='venus', tau_key='tau4', hot_or_cold='cold', use_seeded_O=False, fO2_calculation = 'TARGET_FO2')
	data = run_chili_single(planet='venus', tau_key='tau5', hot_or_cold='hot', use_seeded_O=False, fO2_calculation = 'TARGET_FO2')
	data = run_chili_single(planet='venus', tau_key='tau5', hot_or_cold='cold', use_seeded_O=False, fO2_calculation = 'TARGET_FO2')
