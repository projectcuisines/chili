...
if __name__ == '__main__':
	...
	# data = run_single_test(planet='earth', tau_key='tau3', hot_or_cold='hot')
	data = run_single_test(planet='earth', tau_key='tau3', hot_or_cold='cold')
	data = run_single_test(planet='earth', tau_key='tau4', hot_or_cold='hot')
	data = run_single_test(planet='earth', tau_key='tau4', hot_or_cold='cold')
	data = run_single_test(planet='earth', tau_key='tau5', hot_or_cold='hot')
	data = run_single_test(planet='earth', tau_key='tau5', hot_or_cold='cold')
	
	# --- venus (fill in TAU_CONFIG['venus'] hot/cold models first) ---
	data = run_single_test(planet='venus', tau_key='tau3', hot_or_cold='hot')
	data = run_single_test(planet='venus', tau_key='tau3', hot_or_cold='cold')
	data = run_single_test(planet='venus', tau_key='tau4', hot_or_cold='hot')
	data = run_single_test(planet='venus', tau_key='tau4', hot_or_cold='cold')
	data = run_single_test(planet='venus', tau_key='tau5', hot_or_cold='hot')
	data = run_single_test(planet='venus', tau_key='tau5', hot_or_cold='cold')
