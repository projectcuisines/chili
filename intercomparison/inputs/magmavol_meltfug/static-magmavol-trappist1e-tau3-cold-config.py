...
if __name__ == '__main__':
	...
	# data = run_chili_single(planet='trappist1e', tau_key='tau4', hot_or_cold='hot')
	# data = run_chili_single(planet='trappist1e', tau_key='tau4', hot_or_cold='cold')
	# data = run_chili_single(planet='trappist1e', tau_key='tau6', hot_or_cold='hot')
	# data = run_chili_single(planet='trappist1e', tau_key='tau6', hot_or_cold='cold')
	
	# --- trappist1b ---
	# data = run_chili_single(planet='trappist1b', tau_key='tau3', hot_or_cold='hot')
	# data = run_chili_single(planet='trappist1b', tau_key='tau3', hot_or_cold='cold')
	# data = run_chili_single(planet='trappist1b', tau_key='tau4', hot_or_cold='hot')
	# data = run_chili_single(planet='trappist1b', tau_key='tau4', hot_or_cold='cold')
	# data = run_chili_single(planet='trappist1b', tau_key='tau6', hot_or_cold='hot')
	# data = run_chili_single(planet='trappist1b', tau_key='tau6', hot_or_cold='cold')
	
	# --- trappist1alpha ---
	# data = run_chili_single(planet='trappist1alpha', tau_key='tau3', hot_or_cold='hot')
	# data = run_chili_single(planet='trappist1alpha', tau_key='tau3', hot_or_cold='cold')
	# data = run_chili_single(planet='trappist1alpha', tau_key='tau4', hot_or_cold='hot')
	# data = run_chili_single(planet='trappist1alpha', tau_key='tau4', hot_or_cold='cold')
	# data = run_chili_single(planet='trappist1alpha', tau_key='tau6', hot_or_cold='hot')
	# data = run_chili_single(planet='trappist1alpha', tau_key='tau6', hot_or_cold='cold')
	
	# --- earth (fill in TAU_CONFIG['earth'] hot/cold models first) ---
	# data = run_chili_single(planet='earth', tau_key='tau3', hot_or_cold='hot')
	# data = run_chili_single(planet='earth', tau_key='tau3', hot_or_cold='cold')
	# data = run_chili_single(planet='earth', tau_key='tau4', hot_or_cold='hot')
	# data = run_chili_single(planet='earth', tau_key='tau4', hot_or_cold='cold')
	# data = run_chili_single(planet='earth', tau_key='tau5', hot_or_cold='hot')
	# data = run_chili_single(planet='earth', tau_key='tau5', hot_or_cold='cold')
	
	# --- venus (fill in TAU_CONFIG['venus'] hot/cold models first) ---
	# data = run_chili_single(planet='venus', tau_key='tau3', hot_or_cold='hot')
	# data = run_chili_single(planet='venus', tau_key='tau3', hot_or_cold='cold')
	# data = run_chili_single(planet='venus', tau_key='tau4', hot_or_cold='hot')
	# data = run_chili_single(planet='venus', tau_key='tau4', hot_or_cold='cold')
	# data = run_chili_single(planet='venus', tau_key='tau5', hot_or_cold='hot')
	# data = run_chili_single(planet='venus', tau_key='tau5', hot_or_cold='cold')
